	...
	?>
		...
		<div class="row">
			<div class="large-12 columns">
				<h4><i class="fi-torso"></i> Novi zaposlenik</h4>
				<hr />
			</div>
		</div>
		...
		<div class="row">
			...
			<form id="myform" action="dodajZaposlenika.php" method="post" accept-charset="utf-8" >
					...
					<label for="lozinka">Ponovo lozinka</label>
					<input id="lozinkaponovo" type="password">
					
					<ul class="button-group round">
					<li><a href="index.php" class="round button alert tipkanazad"><i class="fi-arrow-left"></i> Nazad</a></li>
					<li><a href="#" id="dodajZaposlenika" type="submit" class="round button success tipkaspremi"><i class="fi-save"></i> Spremi</a></li>
						...
						<div data-alert class="alert-box success radius alertZaposlenikDodan" style="display: none;">
		...
		<script>
			$(document).ready(function($) {
				...
				$('#dodajZaposlenika').click(function(event) {
				...
				var alertBox = $('.alertZaposlenikDodan');
